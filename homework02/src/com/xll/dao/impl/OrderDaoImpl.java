...
public class OrderDaoImpl extends BaseDao implements OrderDao {
    ...
    public Order findByOrderId(String orderId) {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                order.setBookItemList(getBookItems(rs.getString("books")));
    ...
    public List<Order> query(int start, int num) {
    ...
    public int insert(Order order) {
        ...
        String sql = "INSERT INTO order_table(orderId,customerId,books,money,status,createTime,receiverName,receiverTel,receiverAddress)" +
                " VALUES(?,?,?,?,?,?,?,?,?) ";
        try {
            pstmt = conn.prepareStatement(sql);
            ...
            pstmt.setString(5, order.getOrderStatus().getName());
    ...
    public int update(Order order) {
        ...
        try {
            pstmt = conn.prepareStatement(sql);
            pstmt.setString(1, order.getOrderStatus().getName());
